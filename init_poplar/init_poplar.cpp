        ...
        const std::string& value, bool for_emulator __attribute__((unused)))
{
    ...
    if (key == "oemandroidboot.imei") {
        ...
        if ((count(value.begin(), value.end(),',')) > 0) {
            ...
            property_set("ro.semc.product.name", "Xperia XZ1 Dual");
            ...
            property_override("ro.build.description", "poplar_dsds-user 8.0.0 OPR6.170623.013 1 dev-keys");
            property_override_dual("ro.build.fingerprint", "ro.vendor.build.fingerprint", "Sony/poplar_dsds/poplar_dsds:8.0.0/OPR6.170623.013/1:user/dev-keys");
        } else {
            property_set("ro.telephony.default_network", "10");
            property_set("ro.semc.product.model", "G8341");
            property_set("ro.semc.product.name", "Xperia XZ1");
            ...
            property_override("ro.build.description", "poplar-user 8.0.0 OPR6.170623.013 1 dev-keys");
            property_override_dual("ro.build.fingerprint", "ro.vendor.build.fingerprint", "Sony/poplar/poplar:8.0.0/OPR6.170623.013/1:user/dev-keys");
        }
    }
}
